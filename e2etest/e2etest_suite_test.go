...
func handleFlags() {
	...
	*/
	...
	flag.StringVar(&hostContainerMode, "host-bgp-mode", string(bgptests.IBGPMode), "tells wether to run the host container in ebgp or ibgp mode")
...
var _ = ginkgo.BeforeSuite(func() {
	...
	case externalContainers != "":
		...
		framework.ExpectNoError(err)
	case runOnHost:
		bgptests.FRRContainers, err = bgptests.HostContainerSetup(frrImage, bgptests.HostBGPMode(hostContainerMode))
		framework.ExpectNoError(err)
	default:
